...
CIRCLE_STEP = 5  # bug on 5 with default field size
ATTACK_RADIUS = 550
SWITCH = -1
_BOTTOM = 'b'
_TOP = 't'
...
class RSinTracer(Drone):
    ...
    def build_sin(self, target):
        ...
        first_circle = my_utils.shift_circle(first_circle, my_utils.get_nearest_circle_point_index(self, first_circle))
        second_circle = my_utils.shift_circle(second_circle, my_utils.get_nearest_circle_point_index(self, second_circle))
